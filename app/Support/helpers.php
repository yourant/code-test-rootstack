...
if (!function_exists('is_admin')) {
    function is_admin()
    {
        ...
        return ($user && $user->hasAccess('admin'));
    }
}
...
if (!function_exists('current_marketplace')) {
    /**
     * @return App\Models\Marketplace|null
     */
...
if (!function_exists('count_workdays')) {
     ...
     * @return float
     */
    function count_workdays(\Carbon\Carbon $from, \Carbon\Carbon $to = null, \App\Models\Package $package)
    {
        /** @var App\Services\WorkdaysCalculationService $service */
        $service = resolve('workdays_calculation_service');

        return $service->countWorkdays($from, $to, $package);
    }
}